    ...
    (function (State) {
        var Instructions = (function (_super) {
            ...
            function Instructions() {
                ...
                this.spacing = 20;
                this.colors = ["0xffffff", "0xff0000", "0x00ff00", "0x0000ff", "0xffff00"];
                this.instructionsText = ["Welcome to Euchre! Euchre is a game between 4 people. You, and the person across from you, are partners to win as many points as possible. The objective of the game is to get to 10 points.\n\nThere are several phases to this game: The Trump Calling round and the game round.",
                ...
                this.yvalue = [300, 625, 300, 525, 275];
            }
            ...
            Instructions.prototype.changePage = function (page) {
